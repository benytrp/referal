...
Usage:
  python clean_transcript_json.py INPUT_PATH [--outdir OUTDIR]
...
What it does:
  ...
  - Saves:
      ...
      3) Nvrstry.canonical.json => merged, single canonical JSON (BridgeFile + Contract + Cycle Log)
"""
...
def classify(o: Any) -> str:
    if isinstance(o, dict):
        if "project_metadata" in o and "story_elements" in o:
            # Heuristic: if title looks like a template, caller can filter it
            return "bridgefile"
